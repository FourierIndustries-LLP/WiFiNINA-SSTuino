...
/**
 * Connects to Wi-Fi and MQTT, all in one function
 * 
 * This function is a blocking function, and will ensure that the initial connection succeeds
 *
 * @param network The WiFiClient object representing the Wi-Fi network
 * @param ssid The SSID (Wi-Fi network name) of your Wi-Fi network
 * @param password The password of your Wi-Fi network
 * @param client The MQTTClient object representing the MQTT client
 * @param subscribe The function callback for subscribing to networks, after MQTT successfully connects
 * @param messageReceived The function callback when an incoming message from an MQTT subscription is received
 */
...
/**
 * Checks if the Wi-Fi and MQTT connection are still active
 * 
 * This function is a blocking function, and will ensure that the connection succeeds eventually
 *
 * @param client The MQTTClient object representing the MQTT client
 * @param subscribe The function callback for subscribing to networks, after MQTT successfully (re)connects
 */
